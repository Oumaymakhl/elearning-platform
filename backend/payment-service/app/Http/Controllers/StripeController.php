...
class StripeController extends Controller
{
    public function initiate(Request $request)
    {
        ...
        $session = Session::create([
            ...
            'mode'        => 'payment',
            'success_url' => rtrim(env('FRONTEND_URL', 'https://52-2-181-255.sslip.io'), '/') . '/payment/success?session_id={CHECKOUT_SESSION_ID}&course_id=' . $courseId,
            'cancel_url'  => rtrim(env('FRONTEND_URL', 'https://52-2-181-255.sslip.io'), '/') . '/courses/' . $courseId . '?payment_cancelled=1',
