...
class PaymeeController extends Controller
{
    ...
    public function initiate(Request $request)
    {
        ...
        $session = Session::create([
            ...
            "mode"        => "payment",
            "success_url" => "https://52.2.181.255/payment/success?session_id={CHECKOUT_SESSION_ID}&course_id=" . $request->course_id,
            "cancel_url"  => "https://52.2.181.255/api/payments/cancel",
